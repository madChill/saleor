...
DATABASES = {
    "default": dj_database_url.config(
        default="postgres://postgres:admin123@localhost:5432/saleor", conn_max_age=600
    )
}
...
ALLOWED_HOSTS = get_list(os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,45.32.118.18,45.32.117.237"))
